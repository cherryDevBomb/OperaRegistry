...
export const FAQs = [
  {
    ...
    steps: [
      <React.Fragment>Accesați pagina <i className="fas fa-plus mx-2"/> <strong>Document nou</strong>.</React.Fragment>,
  ...
  },
  {
    ...
    steps: [
      ...
      <React.Fragment>Pentru a vizualiza documentele primite în aplicație, accesați pagina <i className="fas fa-inbox mx-2"/> <strong>Documente primite</strong>.</React.Fragment>,
    ]
  },
  {
    question: "Cum pot rezolva un document care mi-a fost trimis?",
    steps: [
      <React.Fragment>Accesați pagina <i className="fas fa-inbox mx-2"/> <strong>Documente primite</strong>.</React.Fragment>,
  ...
  },
  {
    ...
    steps: [
      <React.Fragment>Dacă documentul a fost înregistrat de către dumneavoastră, accesați pagina <i className="fas fa-paper-plane mx-2"/> <strong>Documentele mele</strong>.
      Dacă sunteți printre destinatarii documentului și doriți să îl trimiteti mai departe, accesați pagina <i className="fas fa-inbox mx-2"/> <strong>Documente primite</strong>.</React.Fragment>,
  ...
  },
  {
    ...
    steps: [
      <React.Fragment>Accesați pagina <i className="fas fa-paper-plane mx-2"/> <strong>Documentele mele</strong>.</React.Fragment>,
  ...
  },
  {
    ...
    steps: [
      <React.Fragment>Accesați pagina <i className="fas fa-paper-plane mx-2"/> <strong>Documentele mele</strong> sau <i className="fas fa-inbox mx-2"/> <strong>Documente primite</strong> și navigați către documentul dorit.</React.Fragment>,
      <React.Fragment>Apăsați butonul <i className="fas fa-file-upload fa-file-upload-rem1 mx-2"/> din dreptul câmpului <strong>Atașament</strong>.</React.Fragment>,
    ...
    note: <React.Fragment>Această acțiune nu poate fi realizată dacă documentul are deja un fișier încărcat. Descărcați fișierul existent folosind butonul <i className="fas fa-file-download fa-file-download-rem1 mx-2"/></React.Fragment>
  },
  {
    question: "Cum pot căuta documente?",
    steps: [
      <React.Fragment>Accesați pagina <i className="fas fa-table mx-2"/> <strong>Toate documentele</strong></React.Fragment>,
      ...
      <React.Fragment>Pentru a filtra documentele afișate după criterii adiționale, expandați bara de căutare apăsând pe <i className="fas fa-caret-down mx-2"/> și alegeți opțiunile dorite.</React.Fragment>,
